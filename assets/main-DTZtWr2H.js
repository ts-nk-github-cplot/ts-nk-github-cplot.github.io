import{i as le,A as se,a as d,L as re,E as h,b as ce,S as pe,c as be,H as w}from"./tsembed.es-B7KT1hvS.js";const me=`import {
    Action,
    AppEmbed,
    AuthType,
    EmbedEvent,
...
> = {
    ...
    'primaryAction: Action.EditVisualization': { primaryAction: Action.EditVisualization },
};
...
`;le({thoughtSpotHost:"https://172.32.12.115:8443",authType:se.None});window.addEventListener("message",e=>{e.data?.type==="__debug_hidden_action_config__"&&console.log("[debug] hidden action config",e.data.data),e.data?.type==="__debug_menu_edit_visibility__"&&console.log("[debug] menu EDIT visibility",e.data.data)});const Z="9bd202f5-d431-44bf-9a07-b4f7be372125",ue="9beaacbf-e65b-4416-b110-238d109c3531";let ee=Z;const T="db0badd5-47c6-400a-842d-133a7b44d435",ge="3c020c5e-1c44-4ceb-a2d6-23ba1c53a3f4",g=document.getElementById("app"),S=document.createElement("div");S.classList.add("full-liveboard");g?.appendChild(S);const U={None:{},"hiddenActions: [Action.Edit]":{hiddenActions:[d.Edit]},"hiddenActions: [Action.EditVisualization]":{hiddenActions:[d.EditVisualization]},"hiddenActions: [Action.EditLiveboard]":{hiddenActions:[d.EditLiveboard]},"visibleActions: [Action.Edit]":{visibleActions:[d.Edit]},"visibleActions: [Action.EditVisualization]":{visibleActions:[d.EditVisualization]},"visibleActions: [Action.EditLiveboard]":{visibleActions:[d.EditLiveboard]},"disabledActions: [Action.Edit]":{disabledActions:[d.Edit]},"disabledActions: [Action.EditVisualization]":{disabledActions:[d.EditVisualization]},"disabledActions: [Action.EditLiveboard]":{disabledActions:[d.EditLiveboard]},"primaryAction: Action.Edit":{primaryAction:d.Edit},"primaryAction: Action.EditVisualization":{primaryAction:d.EditVisualization}},I=document.createElement("div");Object.assign(I.style,{position:"fixed",bottom:"12px",right:"12px",width:"560px",maxWidth:"calc(100vw - 24px)",background:"#ffffff",color:"#1f2328",font:"11px/1.5 ui-monospace, SFMono-Regular, Menlo, monospace",border:"1px solid #d0d7de",borderRadius:"6px",boxShadow:"0 4px 16px rgba(31, 35, 40, 0.16)",zIndex:"9999",overflow:"hidden"});document.body.appendChild(I);const c=document.createElement("div");Object.assign(c.style,{display:"flex",alignItems:"center",gap:"8px",padding:"6px 8px",background:"#f6f8fa",borderBottom:"1px solid #d0d7de",cursor:"pointer",userSelect:"none"});I.appendChild(c);const z=document.createElement("span");z.textContent="Event console";z.style.flex="1";z.style.fontWeight="bold";c.appendChild(z);const s=document.createElement("label");s.style.display="flex";s.style.alignItems="center";s.style.gap="4px";s.title="Log EmbedEvent.ALL";const x=document.createElement("input");x.type="checkbox";x.checked=!0;s.appendChild(x);s.appendChild(document.createTextNode("ALL"));c.appendChild(s);const H=document.createElement("button");H.textContent="Clear";c.appendChild(H);const L=document.createElement("button");L.textContent="–";L.style.width="22px";c.appendChild(L);const f=document.createElement("div");I.appendChild(f);const Y=document.createElement("div");Object.assign(Y.style,{padding:"6px 8px",borderBottom:"1px solid #eaeef2"});f.appendChild(Y);const E=document.createElement("input");E.type="search";E.placeholder="Filter by event name or payload…";Object.assign(E.style,{width:"100%",boxSizing:"border-box",padding:"4px 6px",font:"inherit",border:"1px solid #d0d7de",borderRadius:"4px"});Y.appendChild(E);const l=document.createElement("div");Object.assign(l.style,{maxHeight:"40vh",overflowY:"auto"});f.appendChild(l);[s,H].forEach(e=>{e.onclick=n=>n.stopPropagation()});x.onchange=e=>e.stopPropagation();H.onclick=e=>{e.stopPropagation(),l.replaceChildren()};const ne=()=>{const e=f.style.display==="none";f.style.display=e?"":"none",L.textContent=e?"–":"+"};L.onclick=e=>{e.stopPropagation(),ne()};c.onclick=ne;const te=e=>{const n=E.value.trim().toLowerCase(),t=!n||(e.dataset.search??"").includes(n);e.style.display=t?"":"none"};E.oninput=()=>{Array.from(l.children).forEach(e=>te(e))};const Ee=e=>e.startsWith("HostEvent")?"#8250df":e.startsWith("EmbedEvent.ALL")?"#6e7781":"#0550ae",a=(e,n)=>{let t;try{t=JSON.stringify(n,null,2)??String(n)}catch{t="<unserializable payload — see devtools>"}const o=document.createElement("div");Object.assign(o.style,{padding:"5px 8px",borderBottom:"1px solid #eaeef2"}),o.dataset.search=`${e} ${t}`.toLowerCase();const i=document.createElement("span");i.textContent=`${new Date().toLocaleTimeString()} `,i.style.color="#6e7781";const k=document.createElement("span");k.textContent=e,k.style.color=Ee(e),k.style.fontWeight="bold";const R=document.createElement("pre");Object.assign(R.style,{margin:"2px 0 0",whiteSpace:"pre-wrap",wordBreak:"break-word",color:"#57606a",font:"inherit"}),R.textContent=t;const X=document.createElement("div");X.append(i,k),o.append(X,R),te(o),l.appendChild(o),l.scrollTop=l.scrollHeight};let m,y="Liveboard",P=!0,D=!1,N=!1,W=!1;const $=()=>({showLiveboardTitle:D,isLiveboardMasterpiecesEnabled:N,isLiveboardCompactHeaderEnabled:W,additionalFlags:{isLiveboardHeaderV2Enabled:P}});function oe(e){e.on(h.Edit,n=>{console.log("EmbedEvent.Edit",n),a("EmbedEvent.Edit",n)}),e.on(h.EditLiveboard,n=>{console.log("EmbedEvent.EditLiveboard",n),a("EmbedEvent.EditLiveboard",n)}),e.on(h.EditVisualization,n=>{console.log("EmbedEvent.EditVisualization",n),a("EmbedEvent.EditVisualization",n)}),e.on(h.ALL,n=>{x.checked&&a(`EmbedEvent.ALL → ${n?.type??"unknown"}`,n)})}function de(e){m?.destroy();const n=new re(S,{liveboardId:ee,fullHeight:!0,minimumHeight:600,frameParams:{width:"100%"},showPreviewLoader:!0,enableV2Shell_experimental:!0,...$(),...e,additionalFlags:{...$().additionalFlags,isReorderedEllipsisMenuEnabled:!0}});n.on(h.Data,()=>{console.log("Liveboard rendered")}),oe(n),n.render(),m=n}function ve(e,n){m?.destroy();const t={Search:be,Spotter:pe,"Full app":ce}[e],o=new t(S,{frameParams:{width:"100%"},...e==="Spotter"?{worksheetId:ge,searchOptions:{searchQuery:"draw viz from current data as fast as possible"}}:{},...$(),...n});oe(o),o.render(),m=o}function G(){const e=U[C.value];y==="Liveboard"?de(e):ve(y,e)}const v=document.createElement("div");v.style.padding="8px";v.style.display="flex";v.style.gap="12px";const J=document.createElement("a");J.href="prerender.html";J.textContent="HostEvent.UpdateEmbedParams pre-render debug page →";v.appendChild(J);const Q=document.createElement("a");Q.href="prerender-spotter.html";Q.textContent="Spotter debug page →";v.appendChild(Q);document.body.insertBefore(v,g);const p=document.createElement("div");p.style.display="flex";p.style.gap="12px";p.style.alignItems="center";p.style.padding="8px";document.body.insertBefore(p,g);const ie=document.createElement("label");ie.textContent="Embed type: ";p.appendChild(ie);const he=["Liveboard","Spotter","Full app","Search"];he.forEach(e=>{const n=document.createElement("label"),t=document.createElement("input");t.type="radio",t.name="embedType",t.value=e,t.checked=e===y,t.onchange=()=>{y=e,b.style.display=y==="Liveboard"?"flex":"none",l.replaceChildren(),G()},n.appendChild(t),n.appendChild(document.createTextNode(` ${e}`)),p.appendChild(n)});const r=document.createElement("div");r.style.display="flex";r.style.gap="8px";r.style.alignItems="center";r.style.padding="8px";document.body.insertBefore(r,g);const ae=document.createElement("label");ae.textContent="Action config: ";r.appendChild(ae);const C=document.createElement("select");Object.keys(U).forEach(e=>{const n=document.createElement("option");n.value=e,n.textContent=e,C.appendChild(n)});C.onchange=()=>{G()};r.appendChild(C);const b=document.createElement("div");b.style.display="flex";b.style.gap="8px";b.style.alignItems="center";b.style.padding="8px";document.body.insertBefore(b,g);const A=(e,n,t)=>{const o=document.createElement("label"),i=document.createElement("input");i.type="checkbox",i.checked=n,i.onchange=()=>{t(i.checked),G()},o.appendChild(i),o.appendChild(document.createTextNode(` ${e}`)),b.appendChild(o)};A("isLiveboardHeaderV2Enabled",P,e=>{P=e});A("showLiveboardTitle",D,e=>{D=e});A("isLiveboardMasterpiecesEnabled",N,e=>{N=e});A("isLiveboardCompactHeaderEnabled",W,e=>{W=e});A("System LB",!1,e=>{ee=e?ue:Z});const u=document.createElement("div");Object.assign(u.style,{position:"fixed",inset:"0",background:"rgba(31, 35, 40, 0.5)",display:"none",alignItems:"center",justifyContent:"center",zIndex:"10000"});document.body.appendChild(u);const V=document.createElement("div");Object.assign(V.style,{display:"flex",flexDirection:"column",width:"min(1000px, 90vw)",height:"85vh",background:"#ffffff",border:"1px solid #d0d7de",borderRadius:"6px",overflow:"hidden"});u.appendChild(V);const O=document.createElement("div");Object.assign(O.style,{display:"flex",alignItems:"center",gap:"8px",padding:"8px 10px",background:"#f6f8fa",borderBottom:"1px solid #d0d7de",font:"12px/1.4 ui-monospace, SFMono-Regular, Menlo, monospace"});V.appendChild(O);const _=document.createElement("span");_.textContent="local/index.ts (read-only)";_.style.flex="1";_.style.fontWeight="bold";O.appendChild(_);const q=document.createElement("button");q.textContent="Close";O.appendChild(q);const M=document.createElement("pre");Object.assign(M.style,{margin:"0",padding:"12px",flex:"1",overflow:"auto",font:"12px/1.5 ui-monospace, SFMono-Regular, Menlo, monospace",color:"#1f2328",whiteSpace:"pre",tabSize:"4"});M.textContent=me;V.appendChild(M);const j=e=>{u.style.display=e?"flex":"none",e&&(M.scrollTop=0)};q.onclick=()=>j(!1);u.onclick=e=>{e.target===u&&j(!1)};document.addEventListener("keydown",e=>{e.key==="Escape"&&j(!1)});const K=document.createElement("button");K.textContent="View source";K.onclick=()=>j(!0);r.appendChild(K);de(U[C.value]);const B=document.createElement("div");B.style.display="flex";B.style.gap="8px";B.style.padding="8px";document.body.insertBefore(B,g);const F=(e,n)=>{const t=document.createElement("button");t.textContent=e,t.onclick=()=>{m&&n(m)},B.appendChild(t)};F("Trigger Edit (.Edit)",e=>{a("HostEvent.Edit",{}),e.trigger(w.Edit)});F("Trigger Edit Visualization (.Edit)",e=>{a("HostEvent.Edit",{vizId:T}),e.trigger(w.Edit,{vizId:T})});F("Trigger .EditLiveboard HostEvent",e=>{a("HostEvent.EditLiveboard",{}),e.trigger(w.EditLiveboard,{})});F("Trigger .EditVisualization HostEvent",e=>{a("HostEvent.EditVisualization",{vizId:T}),e.trigger(w.EditVisualization,{vizId:T})});
