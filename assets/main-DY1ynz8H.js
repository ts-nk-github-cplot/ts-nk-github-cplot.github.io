import{i as le,A as se,a as d,L as re,E as h,b as ce,S as pe,c as be,H as T}from"./tsembed.es-8-yNne8p.js";const me=`import {
    Action,
    AppEmbed,
    AuthType,
    EmbedEvent,
...
window.addEventListener('message', (e) => {
    if (e.data?.__tsEmbedConsoleForward) console.log(\`[embed:\${e.data.level}]\`, ...e.data.args);
});
